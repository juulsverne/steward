...
The public anchor is **State St & Madison St (demo)** at an approximate seeded coordinate (`41.88206, -87.62780`). It is a public downtown reference, not a surveyed geocode or a real incident; see the [Chicago grid reference](https://chicagostudies.uchicago.edu/grid/). The internal district and policy IDs remain stable for repeatable fixtures.
